...
// import {Link} from "react-router-dom";
 function Home() {
  ...
  <div className="navbar-center">
    <button>Doctors</button> | <button>About</button>  | <button>Medicines</button>
  </div>
...
<h1>Some Health Tips</h1>
 <div className='health-tips-sec'>
  ...
  <img src="https://ponjeslyhospital.in/wp-content/uploads/2022/12/11.-Master-Health-Check.jpg" alt="" /> </div>
</div> 
