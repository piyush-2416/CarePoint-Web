...
function Emergency() {
    const faqs = [
  {
    ...
    answer:
      "Click on the 'Request Ambulance' button, provide the patient's location, emergency type, and contact number. Our nearest available ambulance will be assigned immediately."
  },
  {
    question: "❤️ What should I do if someone has a heart attack?",
    answer:
      "Call emergency services immediately. Keep the patient calm, loosen tight clothing, and if trained, begin CPR if the patient becomes unconscious. Do not delay seeking medical assistance."
  },
  {
    question: "🩸 What if the patient needs blood urgently?",
    answer:
      "Select the 'Blood Requirement' option, choose the blood group, and submit the request. Nearby blood banks and registered donors will be displayed if available."
  },
  {
    question: "🏥 How is the hospital selected?",
    answer:
      "CarePoint recommends the nearest hospitals based on your location, bed availability, emergency department capacity, and ambulance response time."
  },
  {
    question: "👨‍⚕️ Can I choose a specific hospital?",
    answer:
      "Yes. You can select any hospital listed in the emergency results if it accepts emergency admissions."
  },
  {
    question: "📍 Why does CarePoint need my location?",
    answer:
      "Your location helps dispatch the nearest ambulance, calculate arrival time, and suggest the closest emergency hospitals."
  },
  {
    question: "💳 Do I need to pay before requesting emergency help?",
    answer:
      "No. Emergency requests can be submitted immediately. Payment procedures depend on the selected hospital's policy."
  },
  {
    question: "📞 Can my family track the ambulance?",
    answer:
      "Yes. After confirmation, a live tracking link can be shared with your emergency contacts."
  },
  {
    question: "🩺 What information should I provide?",
    answer:
      "Provide the patient's name, age (if known), symptoms, current location, contact number, and any existing medical conditions."
  },
  {
    question: "⚠️ Can I cancel an emergency request?",
    answer:
      "Yes, but only before the ambulance is dispatched. Once dispatched, contact the emergency support team immediately."
  }
];
    ...
    <section className="bg-slate-100 px-5 py-16">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-3 mb-10 text-gray-600 text-center">
          Find answers to the most common emergency questions.
        </p>

        {faqs.map((faq, index) => (
          <div
            key={index}
            className="bg-white shadow-md mb-4 rounded-xl overflow-hidden"
          >
            <button
              onClick={() =>
