  ...
  return (
      ...
      <div className="navbar-image">
        ...
        <ul>
          <li>
           ...
           <Link className="" to={"/"}> <button className="bg-amber-400">Shop Now</button></Link>
          </li>
        </ul>
      </div>{" "}
   <br/><hr/>
   <h1>Food Menu📜</h1>
      ...
      <iframe
        ...
        title="Google Map"
      ></iframe>
      <div className="map-para"> <br/><br/><h2><b>Live-Location</b></h2><br/><br/>Fast & Transparent Delivery with Live Map Tracking
