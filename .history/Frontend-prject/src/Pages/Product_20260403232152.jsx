...
function Product() {
  ...
  return (
    ...
    //     <h3 style={{ color: "#555" }}>{products.price}</h3>
    ...
    //     )}
    //     {products.description && <p>⭐ Rank: {products.description}</p>}
    //     {products.age && <p>Age: {products.image}</p>}
    //   </div>
    // </div>
    <> <div
              style={{
            ...
            >
              ...
              {item.price && (
                <p style={{ fontWeight: "bold", color: "#e44" }}>res{item.price}</p>
              )}
            </div></>
  );
}
