  ...
  return (
    <>
      <div className="navbar-image">
        ...
        <ul>
          <li>
            <h1 className="caret-teal-200">Hello Shop</h1>
            <button className="bg-amber-400">Shop Now</button>
          </li>
        </ul>
      </div>{" "}
      <br></br>
      ...
      <div className={"About-section"}>
        <img src="https://img.freepik.com/premium-photo/cartoon-chef-holding-plate-food-vector-illustration-white-background_1142-30985.jpg?w=2000"></img>
        <p>
