  ...
  return (
    <div>
      ...
      <div className="service-sec">
        ...
        <br />
        <ul><li>        <img src="https://img.freepik.com/premium-photo/photo-realistic-medical-chart-isolated-white-background-patient-records-healthcare-documentatio_980716-173669.jpg" />
</li><li>     <input placeholder="Enter Paitient Name"></input><br/>
        <input placeholder="Enter the paitient Problem"></input><br/>
        <input placeholder="Enter paitient Address"></input></li></ul>
