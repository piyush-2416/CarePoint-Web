...
<br/><hr/>
 <div className='health-tips sec'>
  ...
  <div className="border collapse collapse-arrow border-base-300 join-item">
    <input type="radio" name="my-accordion-4" defaultChecked />
    <div className="font-semibold collapse-title">How do I create an account?</div>
    <div className="text-sm collapse-content">Click the "Sign Up" button in the top right corner and follow the registration process.</div>
  </div>
  <div className="border collapse collapse-arrow border-base-300 join-item">
    <input type="radio" name="my-accordion-4" />
    <div className="font-semibold collapse-title">I forgot my password. What should I do?</div>
    <div className="text-sm collapse-content">Click on "Forgot Password" on the login page and follow the instructions sent to your email.</div>
  </div>
  <div className="border collapse collapse-arrow border-base-300 join-item">
    <input type="radio" name="my-accordion-4" />
    <div className="font-semibold collapse-title">How do I update my profile information?</div>
    <div className="text-sm collapse-content">Go to "My Account" settings and select "Edit Profile" to make changes.</div>
  </div>
</div>
 </div>
