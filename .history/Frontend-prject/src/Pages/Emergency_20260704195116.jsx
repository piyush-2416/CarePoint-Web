...
function Emergency() {
  ...
  return (
    <div>
      ...
      <div className="collapse collapse-plus bg-base-100 border border-base-300"></div>
        ...
        <div className="mx-auto px-8 py-8 max-w-7xl">
          <div className="gap-8 grid lg:grid-cols-3">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-400">
                  Serving patients with reliable healthcare services across
                  India.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <h3 className="font-semibold text-xl">Secure & Safe</h3>

                <p className="mt-1 text-gray-400">
                  Your personal and medical information is protected with secure
                  encryption.
                </p>
              </div>
            </div>
  ...
  <nav>
   <div className="footer-line1"><h6 className="footer-title">Services</h6><br/>
