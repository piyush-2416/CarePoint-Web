  ...
  return (
    <>
      ...
      <div className={"About-section"}>
        <img className="border-8" src="https://img.freepik.com/premium-photo/cartoon-chef-holding-plate-food-vector-illustration-white-background_1142-30985.jpg?w=2000"></img>
       <br/> <p>
