...
function Doctors() {
  ...
  return (
    <div>
      ...
      <hr /><div className="fab">
  {/* a focusable div with tabIndex is necessary to work on all browsers. role="button" is necessary for accessibility */}
  <div tabIndex={0} role="button" className="btn btn-lg btn-circle btn-info">F</div>
  ...
  <div>🏡 <button className="btn btn-lg btn-circle">A</button></div>
  <div>🏤 <button className="btn btn-lg btn-circle">B</button></div>
  <div> 📞<button className="btn btn-lg btn-circle">C</button></div>
</div>
      {/* </div> */}
    </div>
  );
