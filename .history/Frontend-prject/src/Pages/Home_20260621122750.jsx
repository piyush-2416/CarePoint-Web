...
<ul className="shadow-md bg-base-100 rounded-box list">
  ...
  <li className="list-row">
    ...
    <div><img className="rounded-box size-10" src="https://img.daisyui.com/images/profile/demo/1@94.webp"/></div>
  ...
  <li className="list-row">
    ...
    <div><img className="rounded-box size-10" src="https://img.daisyui.com/images/profile/demo/4@94.webp"/></div>
    <div className="list-col-grow">
  ...
  <li className="list-row">
    ...
    <div><img className="rounded-box size-10" src="https://img.daisyui.com/images/profile/demo/3@94.webp"/></div>
    <div className="list-col-grow">
